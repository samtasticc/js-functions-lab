...
console.log('Exercise 2 Result:', isAdult(35));
...
console.log('Exercise 4 Result:', generateEmail("samantha.henesy", "gmail.com"));
...
console.log('Exercise 7 Result:', calculateTip(120, 20));
